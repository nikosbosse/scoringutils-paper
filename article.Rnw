...
\begin{table}[h!]
\centering
<<forecast-types-table, echo=FALSE, results=tex>>=
...
<<summary-table, echo=FALSE, eval = FALSE, results=tex>>=
...
\begin{figure}[h]
\centering
<<example-calibration, echo=FALSE, fig=TRUE, height=7.2, width=14, eval = FALSE>>=
n_truth = 1000
n_samples = 100
...
\begin{figure}[h]
\centering
<<show-availability, echo=TRUE, fig=TRUE, height=6.7, width=12, eval = TRUE>>=
...
\begin{figure}[h]
\centering
<<score-table, echo=TRUE, fig=TRUE, height=7.2, width=15, eval = TRUE>>=
...
\begin{figure}[h!]
\centering
<<pairwise-plot, echo=TRUE, fig=TRUE, height=7.2, width=14, eval = TRUE>>=
...
\begin{figure}[h!]
\centering
<<WIS-components, echo=TRUE, fig=TRUE, height=5.2, width=12, eval = TRUE>>=
...
\begin{figure}[h!]
\centering
<<coverage, echo=TRUE, fig=TRUE, height=5.2, width=14, out.width = '0.4\\linewidth', fig.show='hold', eval = TRUE>>=
...
\begin{figure}[h]
\centering
<<calibration, echo=TRUE, fig=TRUE, height=5.2, width=15, eval = TRUE>>=
scores <- eval_forecasts(combined, 
                         summarise_by = c("model",
                                          "value_desc", 
                                          "geography"), 
...
\begin{table}[h!]
\centering
<<scores-table, echo=FALSE, results=tex>>=
