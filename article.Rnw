...
\begin{figure}[h]
\centering
<<show-availability, echo=TRUE, fig=TRUE, height=6.7, width=12>>=
...
\begin{figure}[h!]
\centering
<<show-forecasts, echo=TRUE, fig=TRUE, height=5.2, width=7>>=
...
\begin{figure}[h]
\centering
<<score-table, echo=TRUE, fig=TRUE, height=7.2, width=14>>=
...
\begin{figure}[h!]
\centering
<<pairwise-plot, echo=TRUE, fig=TRUE, height=7.2, width=14>>=
...
\begin{figure}[h!]
\centering
<<pairwise-plot-ratio, echo=TRUE, fig=TRUE, height=7.2, width=14>>=
...
\begin{figure}[h!]
\centering
<<pairwise-plot-pval, echo=TRUE, fig=TRUE, height=5.2, width=12>>=
plot_pairwise_comparison(pairwise, type = "together") +
  ggplot2::facet_wrap(~ value_desc, scales = "free_x") 
@
...
\begin{figure}[h!]
\centering
<<WIS-components, echo=TRUE, fig=TRUE, height=5.2, width=12>>=
...
\begin{figure}[h!]
\centering
<<coverage, echo=TRUE, fig=TRUE, height=5.2, width=14, out.width = '0.4\\linewidth', fig.show='hold'>>=
...
<<quantile-coverage, echo=TRUE, fig=TRUE, height=5.2, width=14, out.width = '0.4\\linewidth', fig.show='hold'>>=
cov_scores <- eval_forecasts(combined, 
                             summarise_by = c("model", 
                                              "range", "quantile"))
scoringutils::quantile_coverage(cov_scores)
...
\begin{figure}[h]
\centering
<<calibration, echo=TRUE, fig=TRUE, height=5.2, width=15>>=
scores <- eval_forecasts(combined, 
                         summarise_by = c("model",
                                          "value_desc", 
                                          "geography"), 
