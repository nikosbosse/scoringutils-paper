...
data[, 1:8] %>%
  kableExtra::kbl(format = "latex", booktabs = TRUE, 
                  ...
                  align = c("lccccccl"),
                  linesep = c('\\addlinespace')) %>%
  kableExtra::column_spec(1, width = "1.8 cm") %>%
  ...
  kableExtra::kable_styling(latex_options = c("striped", "repeat_header, scale_down"), font_size = 8) 
...
\begin{figure}[h!]
\centering
<<show-forecasts, echo=TRUE, fig.height=5.2, fig.width=7, eval = TRUE>>=
...
plot_pairwise_comparison(pairwise2) +
  ggplot2::facet_wrap(~ target_type, scales = "free_x") 
@
...
<<pit-plots, echo=TRUE, fig.height=5.2, fig.width=14, out.width="49%", fig.show='hold', eval = TRUE>>=
...
\begin{figure}[h!]
\centering
<<coverage, echo=TRUE, fig.height=5.2, fig.width=14, fig.show='hold', eval = TRUE>>=
...
<<quantile-coverage, fig.height=5.2, fig.width=14, fig.show='hold', eval = TRUE>>=
