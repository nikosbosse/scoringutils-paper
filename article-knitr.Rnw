...
\begin{table}[h!]
\centering
<<forecast-types-table, echo=FALSE, results='asis'>>=

data <- readRDS("tables/forecast-types.rds")
...
<<summary-table, echo=FALSE, eval = FALSE, results='asis'>>=

data <- readRDS("tables/scores-table-summary.rds")
...
data[, 1:4] %>%
  kableExtra::kbl(format = "latex", booktabs = TRUE, 
                  ...
                  longtable = TRUE,
                  linesep = c('\\addlinespace')) %>%
  kableExtra::column_spec(1, width = "12.5cm") %>%
  # kableExtra::column_spec(2, width = "2cm") %>%
  # kableExtra::column_spec(3, width = "4.5cm") %>%
  # kableExtra::column_spec(4, width = "4cm") %>%
  kableExtra::kable_styling(latex_options = c("striped", "repeat_header", "scale_down"), font_size = 2) 
...
\begin{table}[h!]
\centering
<<summary-table2, echo=FALSE, results='asis'>>=

data <- readRDS("tables/scores-table-summary2.rds")
...
data[, 1:8] %>%
  kableExtra::kbl(format = "latex", booktabs = TRUE, 
                  ...
                  align = c("lccccccl"),
                  linesep = c('\\addlinespace')) %>%
  kableExtra::column_spec(1, width = "2.0 cm") %>%
  kableExtra::column_spec(2, width = "1.4cm") %>%
  ...
  kableExtra::column_spec(7, width = "1.2cm") %>%
  kableExtra::column_spec(8, width = "4.5cm") %>%
  kableExtra::kable_styling(latex_options = c("striped", "repeat_header, scale_down"), font_size = 10) 
...
\begin{figure}[h]
\centering
<<example-calibration2, echo=FALSE, fig.height=7.2, fig.width=14, eval = TRUE>>=
knitr::include_graphics(here("plots", "calibration-diagnostic-examples.png"))
@
...
\begin{figure}[h]
\centering
<<show-availability, echo=TRUE, fig.height=6.7, fig.width=12, eval = TRUE>>=
show_avail_forecasts(data = combined, 
                     x = "creation_date", 
                     show_numbers = FALSE,
...
\begin{figure}[h!]
\centering
<<show-forecasts, echo=TRUE, fig.height=5.2, fig.width=7, eval = FALSE>>=
...
\begin{figure}[h]
\centering
<<score-table, echo=TRUE, fig.height=7.2, fig.width=15, eval = TRUE>>=
...
\begin{figure}[h!]
\centering
<<pairwise-plot, echo=TRUE, fig.height=7.2, fig.width=14, eval = TRUE>>=
...
\begin{figure}[h!]
\centering
<<WIS-components, echo=TRUE, fig.height=5.2, fig.width=12, eval = TRUE>>=
...
\begin{figure}[h!]
\centering
<<coverage, echo=TRUE, fig.height=5.2, fig.width=14, out.width="40%", fig.show='hold', eval = TRUE>>=
...
\begin{figure}[h]
\centering
<<calibration, echo=TRUE, fig.height=5.2, fig.width=15, eval = TRUE>>=
scores <- eval_forecasts(combined, 
                         summarise_by = c("model",
                                          "value_desc", 
                                          "geography"), 
...
\begin{table}[h!]
\centering
<<scores-table, echo=FALSE, results='asis'>>=

data <- readRDS("tables/scores-table.rds")
